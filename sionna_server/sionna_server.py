...
class SionnaEnv:
    ...
    def store_simulation_info(self, simulation_info):
        ...
        """
        #print("CALL: ----------> Store_simulation_info()")#test
        ...
        for node_info in simulation_info.nodes:
            ...
            #in case of walking devices (like smartphones)
    ...
    #practically this function is about when user waking with his device
    def walk(self, node_id, delay_left):
        #print("CALL: ----------> walk()")#test
        ...
        #in case of no speed so no movement
        if speed == 0:
            return
        ...
        while True:
            # Create a ray
            # We are using rays because we want to simulate movement path from one room to other
            ...
            if si.is_valid():
                ...
                t = si.t - 0.01 #move back
                position = position + t * direction #calculate the crash position
    ...
    def remove_all_cached_entries(self, simulation_time):
        #print("CALL: ----------> remove_all_cached_entries()")#test
    ...
    def get_position_and_velocity(self, node_id, simulation_time):
        #print("CALL: ----------> get_position_and_velocity()")#test
    ...
    def compute_position_and_velocity(self, node_id, simulation_time):
        ...
        '''
        #print("CALL: ----------> compute_position_and_velocity()")#test
        # If node position is constant, return current position - not moving
        ...
        # Walk until the current simulation time is reached - just moving here
    ...
    def run(self):
        ...
        while socket_open:
            ...
            if from_ns3_wrapper.HasField("sim_init_msg"):
                #print('INSIDE IF : from_ns3_wrapper.HasField("sim_init_msg")')
                ...
                #print('from_ns3_wrapper.HasField("channel_state_request")')
                socket_open = False
                to_ns3_wrapper.sim_ack.SetInParent()
